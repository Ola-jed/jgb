...
public final class ComplexInternals {
    public static final ComplexInternals I = new ComplexInternals(0.0F, 1.0F);
    public static final ComplexInternals ONE = new ComplexInternals(1.0F, 0.0F);
    public static final ComplexInternals ZERO = new ComplexInternals(0.0F, 0.0F);
    private final double imaginary;
    private final double real;

    private ComplexInternals(double real, double imaginary) {
        this.real = real;
        this.imaginary = imaginary;
    }

    public static ComplexInternals ofCartesian(double real, double imaginary) {
    ...
    public ComplexInternals negate() {
        return new ComplexInternals(-this.real, -this.imaginary);
    }

    public ComplexInternals add(ComplexInternals addend) {
        return new ComplexInternals(this.real + addend.real, this.imaginary + addend.imaginary);
    }

    public ComplexInternals add(double addend) {
        return new ComplexInternals(this.real + addend, this.imaginary);
    }

    public ComplexInternals subtract(ComplexInternals subtrahend) {
        return new ComplexInternals(this.real - subtrahend.real, this.imaginary - subtrahend.imaginary);
    }

    public ComplexInternals subtract(double subtrahend) {
        return new ComplexInternals(this.real - subtrahend, this.imaginary);
    }

    public ComplexInternals multiply(ComplexInternals factor) {
        return multiply(this.real, this.imaginary, factor.real, factor.imaginary);
    }

    private static ComplexInternals multiply(double re1, double im1, double re2, double im2) {
        double a = re1;
        double b = im1;
        double c = re2;
        double d = im2;
        ...
        return new ComplexInternals(x, y);
    }
    ...
    public ComplexInternals multiply(double factor) {
        return new ComplexInternals(this.real * factor, this.imaginary * factor);
    }

    public ComplexInternals divide(ComplexInternals divisor) {
        return divide(this.real, this.imaginary, divisor.real, divisor.imaginary);
    }

    private static ComplexInternals divide(double re1, double im1, double re2, double im2) {
        double a = re1;
        double b = im1;
        double c = re2;
        double d = im2;
    ...
    public ComplexInternals divide(double divisor) {
        return new ComplexInternals(this.real / divisor, this.imaginary / divisor);
    }

    public boolean equals(Object other) {
        if (this == other) {
            return true;
        } else if (!(other instanceof ComplexInternals c)) {
            return false;
        } else {
