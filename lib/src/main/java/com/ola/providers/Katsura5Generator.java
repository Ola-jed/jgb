...
public final class Katsura5Generator {
    private Katsura5Generator() {
    }
    ...
    public static List<Polynomial<GaloisFieldElement>> get(MonomialOrdering<GaloisFieldElement> ordering, boolean dense) {
        var polynomials = new ArrayList<Polynomial<GaloisFieldElement>>(6);
        var coefficients = coefficients();
        var monomials = List.of(
                List.of(new int[]{2, 0, 0, 0, 0, 0}, new int[]{0, 2, 0, 0, 0, 0}, new int[]{0, 0, 2, 0, 0, 0}, new int[]{0, 0, 0, 2, 0, 0}, new int[]{0, 0, 0, 0, 2, 0}, new int[]{0, 0, 0, 0, 0, 2}, new int[]{0, 0, 0, 0, 0, 1}),
                List.of(new int[]{1, 1, 0, 0, 0, 0}, new int[]{0, 1, 1, 0, 0, 0}, new int[]{0, 0, 1, 1, 0, 0}, new int[]{0, 0, 0, 1, 1, 0}, new int[]{0, 0, 0, 0, 1, 1}, new int[]{0, 0, 0, 0, 1, 0}),
                List.of(new int[]{1, 0, 1, 0, 0, 0}, new int[]{0, 1, 0, 1, 0, 0}, new int[]{0, 0, 1, 0, 1, 0}, new int[]{0, 0, 0, 0, 2, 0}, new int[]{0, 0, 0, 1, 0, 1}, new int[]{0, 0, 0, 1, 0, 0}),
                List.of(new int[]{1, 0, 0, 1, 0, 0}, new int[]{0, 1, 0, 0, 1, 0}, new int[]{0, 0, 0, 1, 1, 0}, new int[]{0, 0, 1, 0, 0, 1}, new int[]{0, 0, 1, 0, 0, 0}),
                List.of(new int[]{0, 0, 0, 2, 0, 0}, new int[]{1, 0, 0, 0, 0, 1}, new int[]{0, 1, 0, 0, 0, 1}, new int[]{0, 0, 1, 0, 0, 1}, new int[]{0, 1, 0, 0, 0, 0}),
                List.of(new int[]{1, 0, 0, 0, 0, 0}, new int[]{0, 1, 0, 0, 0, 0}, new int[]{0, 0, 1, 0, 0, 0}, new int[]{0, 0, 0, 1, 0, 0}, new int[]{0, 0, 0, 0, 1, 0}, new int[]{0, 0, 0, 0, 0, 1}, new int[]{0, 0, 0, 0, 0, 0})
        );
        ...
        for (int i = 0; i < monomials.size(); i++) {
            ...
            polynomials.add(new Polynomial<>(tempMonomials, 6, ordering));
        }
    ...
    private static List<List<GaloisFieldElement>> coefficients() {
        ...
        return List.of(
                List.of(gf2, gf2, gf2, gf2, gf2, gf1, gfNeg1),
                List.of(gf1, gf1, gf2, gf2, gf2, gfNeg1),
                List.of(gf2, gf2, gf2, gf1, gf2, gfNeg1),
                List.of(gf2, gf2, gf2, gf2, gfNeg1),
                List.of(gf1, gf2, gf2, gf2, gfNeg1),
                List.of(gf2, gf2, gf2, gf2, gf2, gf1, gfNeg1)
        );
    }
}
