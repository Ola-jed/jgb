...
public final class MonomialDivisionIterator<T extends Numeric> implements Iterator<Monomial<T>> {
    ...
    /**
     * Creates a {@code MonomialDivisionIterator} that iterates over all divisors
     * of the given {@code internal} monomial.
     *
     * @param internal the monomial whose divisors will be iterated over
     */
