...
import io.github.olajed.jgb.utils.MatrixSolver;
...
/**
 * Implements the FGLM algorithm for converting a Gröbner basis with respect to one
 * monomial ordering into a Gröbner basis with respect to another ordering.
 *
 * <p>The FGLM algorithm is used to efficiently change the monomial ordering of a
 * zero-dimensional polynomial ideal, preserving the Gröbner basis properties.</p>
 *
 * @see <a href="https://www.sciencedirect.com/science/article/pii/S0747717183710515?via%3Dihub">
 * J.C. Faugère, P. Gianni, D. Lazard, T. Mora - "Efficient Computation of Zero-Dimensional Gröbner Bases by Change of Ordering"</a>
 */
@SuppressWarnings("unchecked")
public final class FGLMAlgorithm {
    private FGLMAlgorithm() {
    }
