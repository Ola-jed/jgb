...
public class PolynomialGenerator implements AstNode.Visitor<Void> {
    ...
    /**
     * Creates a new {@code PolynomialGenerator} with no initial configuration.
     *
     * <p>All settings such as numeric type, variables, monomial type, and ordering
     * must be configured by visiting appropriate AST nodes before use.</p>
     */
